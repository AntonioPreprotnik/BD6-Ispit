...
class Database {
    ...
    public function insert($params) {
        ...
        try {
            ...
            $statement = $this->connection->prepare("INSERT INTO test1 (voce) VALUES (:voce)");

            $statement->bindParam(':voce', $data);
    ...
    public function update($params) {
        ...
        try {
            ...
            $statement = $this->connection->prepare("UPDATE test1 SET voce = :voce WHERE id = :id");

            $statement->bindParam(':id', $params['id']);
            $statement->bindParam(':voce', $params['voce']);
